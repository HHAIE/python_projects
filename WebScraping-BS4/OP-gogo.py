...
non_exist_ep = ["https://gogoanime.run"+ep.parent.get("href") for ep in new_eps if num_from_str(ep.getText()) not in exist_ep][:-20]
...
for link in fhd_links:
    ...
    if not os.path.exists("E:/Videos/Videos/Anime/One Piece"+"/"+link[0]):
